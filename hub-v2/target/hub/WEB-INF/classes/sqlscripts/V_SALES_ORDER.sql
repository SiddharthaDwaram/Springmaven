...
-- SELECT "SO"."SKILL" FROM "RB_SCH_REAL"."TEST_SKILL" AS "SO"

CREATE VIEW "_SYS_BIC"."V_EMP_LIST" AS 
SELECT "SO"."EMPNO","SO"."EMPNAME","SO"."FIRST_NAME" FROM "_SYS_BIC"."rbei.real.i1.data.transaction.views/RA_CV_EMPL_M_WOAP" AS "SO"