...
import com.acme.s4ext.jpa.model.ProjectMaster;
...
public class DeviceSynchronizationIoTApiRestClient {
	 ...
	 */
	public static List<ProjectMaster> getDevices() throws IoTApiRestClientException {
	 ...
	 */
	private static List<ProjectMaster> getDevicesFromJsonInputStream(InputStream jsonInputStream)
			throws UnsupportedEncodingException {
		
		Reader reader = new InputStreamReader(jsonInputStream, "UTF-8");

		Type iotDevicesListType = new TypeToken<ArrayList<ProjectMaster>>() {
		}.getType();
