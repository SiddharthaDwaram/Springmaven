...
@Entity
@ReadOnly
@Table(schema = "\"_SYS_BIC\"", name = "\"rbei.real.i1.data.transaction.views/RA_CV_EMPL_M_WOAP\"")
@NamedQuery(name = AllEmployee.FIND_ALL, query = "select s from AllEmployee s")
public class AllEmployee {

	public static final String FIND_ALL = "AllEmployee.findAll";
	...
	@OneToMany(mappedBy = "AllEmployee")
